/*
       Testing JS web client through the Arduino MKR 1010 using WiFiNina
*/

#include <WiFiNINA.h>

char APssid[] = "helloAccessPoint!";        // your network SSID (name)
char pass[] = "yeahbaby";    // your network password (use for WPA, or use as key for WEP)
...
void setup() {
  ...
  // print the network name (APssid);
  Serial.print("Creating access point named: ");
  Serial.println(APssid);

  // Create open network. Change this line if you want to create an WEP network:
  status = WiFi.beginAP(APssid, pass);
